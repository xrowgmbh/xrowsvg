jQuery( document ).ready(function($)
{
    ...
    var inlinesvg = function(b, n){var a=b.createElement("div");return a.innerHTML="<svg/>",(a.firstChild&&a.firstChild.namespaceURI)==n};
    
    if (!inlinesvg(document, 'http://www.w3.org/2000/svg')) 
    {
